 ...
 *     });
 */
Ext.define('EnvPoolsForms.model.PullRefreshFn', {
    ...
    config: {
         ...
         */
        refreshFn:  null ,
        pullText:  'drop-down can be updated' ,
        lastUpdatedText: "Last refresh time" ,
        lastUpdatedDateFormat: " l, F d, Y g:i:s A" ,
        releaseText: "Release the Start update" ,
