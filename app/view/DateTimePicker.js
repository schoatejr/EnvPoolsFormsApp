...
Ext.define('EnvPoolsForms.view.DateTimePicker', {
    ...
    updateValue: function(newValue) {
        ...
        if (this._picker && this._picker instanceof EnvPoolsForms.view.DateTime) {
    ...
    getPicker: function() {
        ...
        if (picker && !picker.isPicker) {
            picker = Ext.factory(picker, EnvPoolsForms.view.DateTime);
            picker.on({
                scope: this,
